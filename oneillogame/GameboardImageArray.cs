...
namespace GameboardGUI
{
    public class GameboardImageArray : UserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            Load += GameboardImageArray_Load_1;
            ResumeLayout(false);
        }

        private void GameboardImageArray_Load(object sender, EventArgs e)
        {
        }

        private void GameboardImageArray_Load_1(object sender, EventArgs e)
        {
